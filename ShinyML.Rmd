...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("African indigenous vegetables classification prediction"),
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            conditionalPanel( 
                ...
                strong("First-time click to initiate model training and prediction testing.", style = "color: firebrick"),
                br(),
                strong("A following click shuffles the dataset to create new training-testing sets, update models parameters, and refresh prediction results.", 
                       style = "color:steelblue"),
                
                br(),br(),
                
                fluidRow(column(12, actionButton(inputId = "Shuffle", 
                                                 label = "  Model and prediction of AIV categories", 
                                                 icon("paper-plane"), 
                ...
                fluidRow(column(8, sliderInput(inputId = "SplitRatio",
            ...
            conditionalPanel(
                ...
                fluidRow(actionButton(inputId = "Predict2", 
                                      label = "Predict!")),
        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel("Unknown prediction: batch sample",
                         br(),br(),
                         tableOutput("batchPrediction.output1"))
            )
        )
    )
)
...
server <- function(input, output) {
    ...
    output$plt.newShuffle = renderPlot({  p() })
                ...
                if (i == 9) {
                    p2 = t %>% gather(key = model, value = result) %>%
                        ...
                        theme(plot.background =  element_blank(), 
                              ...
                              strip.text = element_text(face = "bold", size = 16, color = "#999999"),
                              legend.position = "NA") +
    ...
    output$batchPrediction.output1 = renderTable(tab3.output() )
